...
#PROMPT='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\W\[\033[00m\] $ '
...
plugins=(git colored-man-pages fzf zsh-syntax-highlighting)
...
# basic prompt
PROMPT='%{$fg[green]%}%c%{$reset_color%}$(git_prompt_info) %{$fg[magenta]%}%(!.#.$)%{$reset_color%} '
